...
CylinderToCylinderContact::CylinderToCylinderContact(Fixture *fixtureA, Fixture *fixtureB, int32_t indexA, int32_t indexB)
...
{
	return new CylinderToCylinderContact(fixtureA, fixtureB, indexA, indexB);
}
