...
std::unique_ptr<SwapChainManager> SwapChainManager::create(GLFWwindow *window, DeviceManager *deviceManager,
...
void SwapChainManager::createImageViews()
{
	...
	{
		swapChainImageViews[i] = Image::createSwapChainImageView(device, swapChainImages[i], swapChainImageFormat,
...
*/
void SwapChainManager::recreateSwapChain(GLFWwindow *window, DeviceManager *deviceManager, VkSurfaceKHR surface,
