...
public:
	...
	static std::unique_ptr<Model> createBox(DeviceManager* deviceManager, VkCommandPool commandPool, std::string diffusePath = "black", std::string specularPath = "black");
	static std::unique_ptr<Model> createSphere(DeviceManager* deviceManager, VkCommandPool commandPool, std::string diffusePath = "black", std::string specularPath = "black");
...
private:
	...
	void createBoxMesh(DeviceManager* deviceManager, VkCommandPool commandPool, std::string diffusePath, std::string specularPath);
	void createSphereMesh(DeviceManager* deviceManager, VkCommandPool commandPool, std::string diffusePath, std::string specularPath);
